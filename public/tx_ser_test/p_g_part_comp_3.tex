...
\begin{tikzpicture}[scale=1,transform shape]
  ...
  \Edge[label=x+z,Direct,bend=35](t0)(t1)
  \Edge[label=x+y,Direct,bend=-20](t0)(t3)
  \Edge[label=x+y,Direct,bend=-15](t3)(t4)
  ...
  % tinf -> t5 -> t1 [label=z]
  \Edge[Direct,style=dashed,color=red!75](tinf)(t5)
  \Edge[Direct,style=dashed,color=red!75](t5)(t1)
  \path[draw] pic[draw,angle radius=1cm,opacity=0.5,"$z$",color=red!75] {angle = tinf--t5--t1};
