...
graphs/every graph/.style={edges=rounded corners}]
  ...
  \coordinate (w1x1) at (1  ,4);
  \coordinate (c1) at (1.8  ,4);
  \coordinate (r2x1) at (2.2,3);
  \coordinate (w2y2) at (3.2,3);
  \coordinate (c2) at (4  ,3);
  \coordinate (w0x0) at (4.5,2);
  \coordinate (w0y0) at (5.5,2);
  \coordinate (c0) at (6.3,2);
