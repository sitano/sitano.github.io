...
v57 = OffPtr <**[]byte> [8] v2      ; ptr to stack[8] (arg1)
v59 = OffPtr <*int> [16] v2         ; arg2
v61 = OffPtr <*int> [24] v2         ; arg3
v63 = OffPtr <*int> [32] v2         ; arg4
v66 = OffPtr <**[]byte> [40] v2     ; arg5
v68 = OffPtr <*int> [48] v2         ; arg6
...
v33 = Copy <mem> v27
v34 = Load <*S> v32 v33
v35 = NilCheck <void> v34 v33
v36 = Copy <*S> v100
v37 = Move <mem> {S} [8] v36 v34 v33
v38 = OffPtr <*[8]byte> [0] v36
v40 = NilCheck <void> v38 v37
v42 = IsSliceInBounds <bool> v39 v41
If v42 → b6 b7 (likely)
b4: ← b9
